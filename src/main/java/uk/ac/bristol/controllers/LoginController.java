              ...
              switch (source.getId()) {
                case "TokenLogin":
                  ...
                  try {
                    loginTokenInfo =
                        new LoginTokenInfo(
                            dialog.getEditor().getText(), tokenID.getText(), token.getText());
                  } catch (Exception ex) {
                  ...
                  break;
                case "SSHLogin":
                  if (sshID.getText().equals("")
                      || keyPath.getText().equals("")
                ...
                case "HTTPSLogin":
                  ...
                  GitInfo.addHTTPS(httpsID.getText(), username.getText(), password.getText());
                  break;
              }
            });
            ...
            res -> {
              ...
              for (int i = 0; i < sshInfos.size(); i++) {
                if (sshInfos.get(i).getKey().equals(dialog.getEditor().getText())) {
                  ...
                  GitInfo.addSSH(
                      sshInfos.get(i).getId(),
                      sshInfos.get(i).getPath(),
                      sshInfos.get(i).getDecryptPassphrase());
                  accountIsExist = true;
                }
              }
            ...
            res -> {
              ...
              for (int i = 0; i < httpsInfos.size(); i++) {
                if (httpsInfos.get(i).getKey().equals(dialog.getEditor().getText())) {
                  GitInfo.getHttpAuth()
                      .put(
                          httpsInfos.get(i).getId(),
                          new UsernamePasswordCredentialsProvider(
                              httpsInfos.get(i).getUserName(),
                              httpsInfos.get(i).getDecryptPassword()));
                  accountIsExist = true;
                }
              }
            ...
            res -> {
              ...
              for (int i = 0; i < tokenInfos.size(); i++) {
                if (tokenInfos.get(i).getKey().equals(dialog.getEditor().getText())) {
                  GitInfo.getHttpAuth()
                      .put(
                          tokenInfos.get(i).getId(),
                          new UsernamePasswordCredentialsProvider(
                              tokenInfos.get(i).getDecryptToken(), ""));
                  accountIsExist = true;
                }
              }
