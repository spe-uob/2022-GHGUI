...
public class JgitTest {
  ...
  public static void main(String[] args) throws GitAPIException {
    ...
    UsernamePasswordCredentialsProvider usernamePasswordCredentialsProvider =
        new UsernamePasswordCredentialsProvider("su21085", "Ww121213.");
    git.pull()
        .setRemoteBranchName("dev-su")
  ...
  //
  //            UsernamePasswordCredentialsProvider pro = new
  // UsernamePasswordCredentialsProvider("su21085", "Ww121213.");
  //            refList =
