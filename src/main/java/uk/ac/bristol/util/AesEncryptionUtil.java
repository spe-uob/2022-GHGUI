...
public class AesEncryptionUtil {
    ...
    public static String decrypt(String encryptedText, String key) throws Exception {
        ...
        byte[] decrypted = cipher.doFinal(Base64.getDecoder().decode(encryptedText)); // Decrypt the encrypted text
    ...
    public static void main(String[] args) throws Exception {
        ...
        //right key
        String decryptedText1 = AesEncryptionUtil.decrypt(encryptedText, key);
        System.out.println("Decrypted Text: " + decryptedText1);

        //erro key
        String decryptedText2 = AesEncryptionUtil.decrypt(encryptedText, "0123456789123456");
